...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'eye-off'">
      <path d="m3 3 18 18" />
      <path d="M10.6 6.2A10 10 0 0 1 12 6c6 0 9.5 6 9.5 6a15.8 15.8 0 0 1-2.1 2.8M6.1 6.1C3.8 7.7 2.5 12 2.5 12s3.5 6 9.5 6a9.6 9.6 0 0 0 3-.5" />
    </template>
    <template v-else-if="name === 'arrow-right'">
      <path d="M5 12h14M13 6l6 6-6 6" />
    </template>
    <template v-else-if="name === 'shield'">
      <path d="M12 3 5.5 6v5.2c0 4.4 2.7 7.6 6.5 9.8 3.8-2.2 6.5-5.4 6.5-9.8V6L12 3Z" />
    ...
    <template v-else-if="name === 'settings'">
      ...
      <path d="M19.4 15a1.8 1.8 0 0 0 .4 2l.1.1-2.8 2.8-.1-.1a1.8 1.8 0 0 0-2-.4 1.8 1.8 0 0 0-1 1.7V21h-4v-.1a1.8 1.8 0 0 0-1-1.7 1.8 1.8 0 0 0-2 .4l-.1.1-2.8-2.8.1-.1a1.8 1.8 0 0 0 .4-2 1.8 1.8 0 0 0-1.7-1H3v-4h.1a1.8 1.8 0 0 0 1.7-1 1.8 1.8 0 0 0-.4-2l-.1-.1 2.8-2.8.1.1a1.8 1.8 0 0 0 2 .4 1.8 1.8 0 0 0 1-1.7V3h4v.1a1.8 1.8 0 0 0 1 1.7 1.8 1.8 0 0 0 2-.4l.1-.1 2.8 2.8-.1.1a1.8 1.8 0 0 0-.4 2 1.8 1.8 0 0 0 1.7 1h.1v4h-.1a1.8 1.8 0 0 0-1.7.8Z" />
    </template>
    ...
    <template v-else-if="name === 'help'">
      ...
      <path d="M9.8 9a2.3 2.3 0 1 1 3.4 2c-.8.4-1.2 1-1.2 2M12 17h.01" />
    </template>
    ...
    <template v-else-if="name === 'users'">
      ...
      <path d="M3 19v-1a5 5 0 0 1 5-5h2a5 5 0 0 1 5 5v1H3Z" />
      <path d="M16 5.2a3 3 0 0 1 0 5.6M18 13a5 5 0 0 1 3 4.6V19h-3" />
    </template>
    ...
    <template v-else-if="name === 'chart'">
      ...
      <path d="M7 17v-4M12 17V8M17 17v-7M7 7h2" />
    </template>
